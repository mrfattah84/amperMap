export default function createNumberedPin(number, pinColor = "#5a5a5a") {
  // Adjust font size based on the number of digits for better fit
  ...
  // Using a template literal to construct the SVG string
  const svgString = `
                <svg display="block" height="41px" width="27px" viewBox="0 0 27 41">
                    <g fill-rule="nonzero">
                        ...
                        <!-- This is the group for the circle and the number -->
                        <g transform="translate(8.0, 8.0)">
                            <circle fill="#000000" opacity="0.25" cx="5.5" cy="5.5" r="5.4999962"></circle>
                            <circle fill="#FFFFFF" cx="5.5" cy="5.5" r="8"></circle>
                            <!-- The number is added here -->
                            <text x="5.5" y="5.8" 
